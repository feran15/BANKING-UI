...
export const Subfooter = () => {
    return(
        <div className="mt-32">
            ...
            <p className= "text-[rgb(18,34,49)] text-2xl leading-relaxed">Grow your money and invest for your future confidently.</p>
            </div>
            <div className="bg-[rgb(121,19,229)] mt-12 rounded-2xl shadow-md px-2 py- w-full max-w-6xl flex justify-around  ms-25">
            <div className="px-2 py-6">
                    <h2 className="text-white font-bold text-2xl sm:text-3xl group-hover:text-white mt-5">
                    ...
                    <div className="Image-section w-100 mt-12">
